...
- **`src/`**: Python source code and verification scripts.
  - `final_v73_verification.py`: Master script to verify all four forced completions.
...
- **`logs/`**: Historical development journals and conversation transcripts.

## Quick Start: Verification
To verify the theoretical edifice against empirical data (PDG 2024 / Planck 2020):
```bash
python3 src/final_v73_verification.py
```
